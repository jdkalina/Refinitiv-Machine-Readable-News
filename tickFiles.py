...
def generateFiles(token, requestUrl,requestHeaders,requestBody, filePath = "/home/josh/Documents/tickFiles/"):
    ...
    if status_code == 202 :
        ...
        if ( (index+1) % 10) == 0:
            print("PROGRESS: Finished file" + str(index) + ' of ' + str(len(sortFiles)))
        index+=1
